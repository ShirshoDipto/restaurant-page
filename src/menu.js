...
function insertAllDivs(mainContainer, pic1, pic2, pic3, pic4, pic5, pic6) {
...
function loadMenu(mainContainer, pic1, pic2, pic3, pic4, pic5, pic6) {
    if (mainContainer.firstElementChild === null || mainContainer.firstElementChild.classList.value !== 'all-menus') {

        if (mainContainer.firstElementChild === null) {
            insertAllDivs(mainContainer, pic1, pic2, pic3, pic4, pic5, pic6)
        }
        else {
